...
RUN dnf makecache --refresh \
    ...
    SDL2-devel SDL2_ttf-devel SDL2_image-devel SDL3-devel SDL3_image-devel flac-devel libmpg123-devel libpng-devel libmpeg2-devel libserialport-devel portmidi-devel enet-devel libpcap-devel libzstd-devel libcurl-devel nlohmann-json-devel dbus-devel \
    && dnf clean all \
    && rm -rf /var/cache/dnf
